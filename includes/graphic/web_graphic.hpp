...
namespace graphic
{
    ...
    class WebGraphic
    {
        public:
             ...
             */
            WebGraphic(Type t = Type::STANDARD);
             ...
             *      This could happen when the name specified is already used or 
             *      is empty.
             */
        ...
        private:
            ...
            /**
             * Send to the Receiver the type of graphic to create.
             */
            void specifyGraphicType(graphic::Type t);
